...
namespace Scoreboard
{
    public class AddUpdateMatch : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtTeam1.Text = "nhấp chuột 2 lần...";
            ...
            this.txtTeam2.Text = "nhấp chuột 2 lần...";
            ...
            this.lblTrongTai.ForeColor = System.Drawing.Color.Red;
    ...
    "ll files (*.*)|*.*";
        ...
        private void PopulateFromModel(MatchModel m)
        {
            ...
            lblId1.Text = m.Team1Id.ToString();
            lblId2.Text = m.Team2Id.ToString();
            LoadFlagToPictureBox(m.Team1Flag, pbTeam1Flag);
            LoadFlagToPictureBox(m.Team2Flag, pbTeam2Flag);
        ...
        public AddUpdateMatch(int tournament_id, string id = "")
        {
            ...
            if (lblId1.Text.Length ==0)
            {
                lblId1.Text = "-1";
            }
            if (lblId2.Text.Length == 0)
            {
                lblId2.Text = "-1";
            }
        }
