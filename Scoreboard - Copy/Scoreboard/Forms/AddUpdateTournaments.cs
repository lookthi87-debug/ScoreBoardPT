...
namespace Scoreboard
{
    public class AddUpdateTournaments : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTenGiaiDau.ForeColor = System.Drawing.Color.Red;
            ...
            this.lblClassMatch.ForeColor = System.Drawing.Color.Red;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    int id = Repository.AddTournament(currentTournament);
